...
_RECIPES: list[dict] = [
    ...
    # -----------------------------------------------------------------
    {
        ...
        "tile_sequence": ["poster", "event-details", "feature-buttons", "footer"],
    ...
    },
    {
        ...
        "tile_sequence": ["poster", "timer", "event-details", "feature-buttons", "footer"],
    ...
    },
    {
        ...
        "tile_sequence": ["poster", "description", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "light_overlay",
    ...
    },
    {
        ...
        "tile_sequence": ["poster", "description", "timer", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "light_overlay",
        "fits": list(WEDDING_FAMILY) + list(LIFE_EVENTS),
        "weight": 0.7,
        "requires": {"min_quiet_regions": 1},
    ...
    },
    {
        ...
        "tile_sequence": ["poster", "event-details", "event-carousel", "feature-buttons", "footer"],
        "overlay_strategy": "full_overlay",
        "fits": list(WEDDING_FAMILY) + list(RELIGIOUS),
        "weight": 0.6,
    ...
    {
        "id": "poster-overlay-with-story",
        "tile_sequence": ["poster", "description", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "full_overlay",
        "fits": list(WEDDING_FAMILY) + list(SOCIAL) + list(LIFE_EVENTS),
        "weight": 0.6,
        "requires": {"min_quiet_regions": 1},
        "description": "Full-bleed poster with overlays, story paragraph, then RSVP.",
    },
    # -----------------------------------------------------------------
    ...
    {
        "id": "card-then-title",
        "tile_sequence": ["poster", "title", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "none",
        "fits": ["all"],
        "weight": 2.2,  # safe everywhere, slight preference
        "requires": {},
        "description": "Card + separate title tile + details. Works even with baked-text cards.",
    },
    {
        "id": "card-then-banner",
        "tile_sequence": ["poster", "title", "timer", "event-details", "feature-buttons", "footer"],
    ...
    {
        "id": "title-leads-card",
        "tile_sequence": ["title", "poster", "event-details", "feature-buttons", "footer"],
    ...
    {
        "id": "story-first-card",
        "tile_sequence": ["description", "poster", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "none",
        "fits": ["all"],
        "weight": 0.65,
        "requires": {},
    ...
    },
    {
        ...
        "tile_sequence": ["poster", "description", "title", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "none",
        "fits": ["all"],
        "weight": 0.55,
        "requires": {},
    ...
    },
    {
        ...
        "tile_sequence": ["title", "poster", "description", "timer", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "separate_title",
        "fits": list(WEDDING_FAMILY) + list(LIFE_EVENTS),
        "weight": 0.55,
        "requires": {},
    ...
    },
    {
        ...
        "tile_sequence": ["title", "poster", "description", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "separate_title",
    ...
    },
    {
        ...
        "tile_sequence": ["title", "poster", "event-details", "event-carousel", "feature-buttons", "footer"],
        "overlay_strategy": "separate_title",
    ...
    {
        "id": "corporate-formal",
        "tile_sequence": ["title", "poster", "event-details", "description", "feature-buttons", "footer"],
        "overlay_strategy": "separate_title",
    ...
    },
    {
        ...
        "tile_sequence": ["poster", "timer", "event-details", "description", "feature-buttons", "footer"],
        "overlay_strategy": "full_overlay",
    ...
    {
        "id": "festival-bold",
        "tile_sequence": ["title", "poster", "timer", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "separate_title",
    ...
    # -----------------------------------------------------------------
    {
        ...
        "tile_sequence": ["title", "description", "poster", "event-details", "feature-buttons", "footer"],
        "overlay_strategy": "separate_title",
        "fits": list(RELIGIOUS),
        "weight": 1.1,
        "requires": {},
