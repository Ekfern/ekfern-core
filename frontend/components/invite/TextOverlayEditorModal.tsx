                      ...
                      >
                        ...
                        {isSelected && !isEditing && (
                          <button
                            ...
                            style={{
                              position: 'absolute',
                              // Inside the corner, not hanging off it: the canvas
                              // is `overflow-hidden`, so an outside handle gets
                              // sliced in half on a box sitting flush to the card
                              // edge — and clipped away entirely on one dragged
                              // right up to it.
                              top: 2,
                              right: 2,
                              width: 22,
